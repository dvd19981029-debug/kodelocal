...
export default function InventarioPage() {
  ...
  const handleSaveProduct = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      priceHalfOunce: formData.priceHalfOunce != null ? Number(formData.priceHalfOunce) : undefined,
      finishedPerfumePrice: formData.finishedPerfumePrice != null ? Number(formData.finishedPerfumePrice) : undefined,
    ...
    try {
      ...
      await fetch('/api/products', {
        ...
        body: JSON.stringify({
          ...
          price: payload.price,
          priceHalfOunce: payload.priceHalfOunce,
          finishedPerfumePrice: payload.finishedPerfumePrice,
          cost: payload.cost,
          stock: payload.stock,
    ...
    <div className="flex flex-col gap-6 pb-12">
      ...
      <div className="clay-card p-4 sm:p-5 flex flex-col sm:flex-row gap-4 justify-between items-center">
        ...
        <div className="relative flex-1 w-full">
          ...
          <input
            type="text"
            placeholder="Buscar por producto, marca, SKU o código de barras..."
            value={searchQuery}
